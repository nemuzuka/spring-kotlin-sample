...
/**
 * DoneTaskApiController(reopen) の IntegrationTest.
 */
@ExtendWith(SpringExtension::class)
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("integrationtest")
class ReopenTaskApiIntegrationTest {

    companion object {
        const val PATH = "/api/tasks/{task_code}/_reopen"
    }
    ...
    @Test
    fun testReopenTask_InvalidVersion_409() {
        // setup
        val createRequest = CreateTaskApiParameterFixtures.create()
        taskIntegrationHelper.createTask(mockMvc, createRequest)
        val taskCode = createRequest.taskCode
    ...
    @Test
    fun testReopenTask_InvalidPathParameter_400() {
        // execution
        ...
        assertThat(exception.message).isEqualTo("reopenTask.taskCode: must match \"[a-zA-Z0-9][-a-zA-Z0-9_]{0,127}\"")
    }
}
